...
import aind_behavior_dynamic_routing_bonsai
import aind_behavior_dynamic_routing_bonsai.data_contract as contract
import aind_behavior_dynamic_routing_bonsai.rig
import aind_behavior_dynamic_routing_bonsai.task_logic

SOURCE_ROOT = "https://github.com/AllenNeuralDynamics/Aind.Behavior.DynamicRoutingBonsai/tree/main/src/"

# -- Project information -----------------------------------------------------
# https://www.sphinx-doc.org/en/master/usage/configuration.html#project-information

project = " dynamic-routing-bonsai "
copyright = "2025, Allen Institute for Neural Dynamics"
author = " RoboDoig "
release = aind_behavior_dynamic_routing_bonsai.__semver__
...
html_title = "dynamic-routing-bonsai"
